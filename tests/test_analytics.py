...
def analytics_tenant(client):
    ...
    rt1 = client.post(f"/api/v1/tenants/{t['id']}/room-types", json={"code": "STD", "name": "标准间", "base_price": 30000}).json()
    rt2 = client.post(f"/api/v1/tenants/{t['id']}/room-types", json={"code": "DLX", "name": "豪华间", "base_price": 40000}).json()
